...
class PermissionStatusEnum(StrStructuredEnum):
...
class PermissionLevelEnum(StrStructuredEnum):
...
class PermissionActionEnum(StrStructuredEnum):
...
class GrantDimensionEnum(StrStructuredEnum):
