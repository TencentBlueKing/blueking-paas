...
urlpatterns = [
    ...
    path(
        "api/cloudapi_v2/apps/<slug:app_code>/open/mcp-servers/",
        views.CloudAPIV2ViewSet.as_view({"get": "list_mcp_servers"}),
        name="api.cloudapi.v2.mcp_servers",
    ),
    # 获取指定 mcp-server 权限列表
    path(
        "api/cloudapi_v2/apps/<slug:app_code>/open/mcp-servers/<int:mcp_server_id>/permissions/",
    ...
    path(
        "api/cloudapi_v2/apps/<slug:app_code>/open/mcp-servers/permissions/",
    ...
    # 批量申请权限
    path(
        "api/cloudapi_v2/apps/<slug:app_code>/open/mcp-servers/permissions/apply/",
        views.CloudAPIV2ViewSet.as_view({"get": "apply_mcp_server_permissions"}),
        name="api.cloudapi.v2.mcp_server_permissions_apply",
    ),
    # 申请记录
    path(
        "api/cloudapi_v2/apps/<slug:app_code>/open/mcp-servers/permissions/apply-records/",
