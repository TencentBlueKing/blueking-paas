    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='沙箱标识,模块下唯一', max_length=8, unique=True)),
                ('status', models.CharField(choices=[('active', '存活'), ('expired', '过期'), ('error', '错误')], max_length=32, verbose_name='沙箱状态')),
