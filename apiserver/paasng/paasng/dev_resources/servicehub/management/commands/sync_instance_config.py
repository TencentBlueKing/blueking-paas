...
from paasng.dev_resources.servicehub.remote import RemoteServiceMgr
from paasng.dev_resources.servicehub.remote.manager import RemoteEngineAppInstanceRel, RemoteServiceObj
