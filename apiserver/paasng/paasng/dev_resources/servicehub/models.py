...
from paasng.dev_resources.servicehub.constants import ServiceType
from paasng.dev_resources.servicehub.services import ServiceObj
from paasng.dev_resources.services.models import Plan, Service, ServiceInstance
...
class SharedServiceAttachmentManager(models.Manager):
    ...
    def list_by_ref_module(self, service: ServiceObj, module: Module) -> 'Collection[SharedServiceAttachment]':
        ...
        from paasng.dev_resources.servicehub.manager import get_db_properties
