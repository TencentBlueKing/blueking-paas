...
if TYPE_CHECKING:
    from paasng.dev_resources.services.providers.base import BaseProvider
...
class Service(UuidAuditedModel):
    ...
    def _get_service_vendor_instance(self, plan: 'Plan') -> 'BaseProvider':
        from paasng.dev_resources.services.providers import get_provider_cls_by_provider_name
