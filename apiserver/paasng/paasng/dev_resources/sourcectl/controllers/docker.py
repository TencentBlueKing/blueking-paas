...
from paasng.dev_resources.sourcectl.models import AlternativeVersion, RepoBasicAuthHolder, VersionInfo
from paasng.dev_resources.sourcectl.source_types import docker_registry_config
