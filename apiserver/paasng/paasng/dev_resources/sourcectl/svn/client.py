...
from paasng.dev_resources.sourcectl.exceptions import DoesNotExistsOnSvnServer
from paasng.dev_resources.sourcectl.svn.exceptions import AlreadyInitializedSvnRepo, CannotInitNonEmptyTrunk
from paasng.dev_resources.sourcectl.utils import compress_directory, generate_temp_dir, get_all_intermediate_dirs
...
class SvnRepositoryClient:
    ...
    def list_alternative_versions(self):
        ...
        from paasng.dev_resources.sourcectl.models import AlternativeVersion
