...
from paasng.misc.tools.smart_app.build.building import start_build, start_build_error_callback
from paasng.platform.engine.constants import JobStatus
from paasng.misc.tools.smart_app.signals import pre_build_start

logger = logging.getLogger(__name__)


def initialize_smart_build_record(package_name: str, app_code: str, operator: str) -> SmartBuild:
    ...
    :return: The created SmartBuild instance
    """
    # TODO: 添加对源码仓库的支持
    source_origin = SourceCodeOriginType.PACKAGE

    record = SmartBuild.objects.create(
