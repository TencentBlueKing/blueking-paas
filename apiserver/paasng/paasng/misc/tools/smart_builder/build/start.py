...
from paasng.misc.tools.smart_builder.signals import pre_build_start
from paasng.platform.engine.constants import JobStatus

from .tasks import dispatch_build, dispatch_build_error_callback

logger = logging.getLogger(__name__)


def create_smart_build_record(package_name: str, app_code: str, operator: str) -> SmartBuild:
...
class SmartBuildTaskRunner:
    ...
    def start(self):
        ...
        dispatch_build.apply_async(
            args=(smart_build_id, self.source_url, self.package_path),
            link_error=dispatch_build_error_callback.s(),
        )
