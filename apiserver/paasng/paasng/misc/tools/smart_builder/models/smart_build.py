...
class SmartBuild(UuidAuditedModel):
    """s-mart 包构建记录"""
...
class SmartBuildLogLine(models.Model):
    smart_build_log = models.ForeignKey(SmartBuildLog, related_name="lines", on_delete=models.CASCADE)
