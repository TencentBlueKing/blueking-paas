...
class AppOperationReportOutputSLZ(serializers.Serializer):
    ...
    last_deployed_at = serializers.DateTimeField(help_text="最新部署时间")
    last_deployer = serializers.CharField(help_text="最新部署人")
    last_operated_at = serializers.DateTimeField(help_text="最新操作时间")
    last_operator = serializers.CharField(help_text="最新操作人")
    last_operation = serializers.CharField(help_text="最新操作内容")
