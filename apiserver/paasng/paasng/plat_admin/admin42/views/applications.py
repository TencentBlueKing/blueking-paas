...
class ApplicationListView(GenericTemplateView):
    ...
    template_name = "admin42/configuration/applications/list_applications.html"
...
class ApplicationDetailBaseView(GenericTemplateView):
    ...
    template_name = "admin42/configuration/applications/detail/base.html"
    permission_classes = [IsAuthenticated, site_perm_class(SiteAction.MANAGE_PLATFORM)]
    # 描述当前高亮的导航栏
    name: str = ""
...
class ApplicationOverviewView(ApplicationDetailBaseView):
    ...
    queryset = Application.objects.all()
    serializer_class = ApplicationSLZ
    template_name = "admin42/configuration/applications/detail/overview.html"
    name = "概览"
...
class ApplicationMembersManageView(ApplicationDetailBaseView):
    ...
    template_name = "admin42/configuration/applications/detail/base_info/members.html"
    name = "成员管理"
...
class ApplicationFeatureFlagsView(ApplicationDetailBaseView):
    ...
    template_name = "admin42/configuration/applications/detail/base_info/app_feature_flags.html"
    name = "特性管理"
