...
class BuildPackManageView(GenericTemplateView):
    name = "BuildPack 管理"
    template_name = "admin42/configuration/runtimes/buildpacks.html"
...
class SlugBuilderManageView(GenericTemplateView):
    name = "SlugBuilder 管理"
    template_name = "admin42/configuration/runtimes/slugbuilders.html"
    permission_classes = [IsAuthenticated, site_perm_class(SiteAction.MANAGE_PLATFORM)]
...
class AppSlugRunnerManageView(GenericTemplateView):
    name = "SlugRunner 管理"
    template_name = "admin42/configuration/runtimes/slugrunners.html"
    permission_classes = [IsAuthenticated, site_perm_class(SiteAction.MANAGE_PLATFORM)]
