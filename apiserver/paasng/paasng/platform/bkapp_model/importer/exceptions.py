...
class ManifestImportError(Exception):
    """Error importing a manifest data.
    ...
    @classmethod
    def from_validation_error(cls, error: ValidationError) -> "ManifestImportError":
        """Transform DRF's ValidationError into ManifestImportError"""
