...
from paasng.platform.bkapp_model.services import upsert_proc_svc_if_implicit_needed
...
class ImageReleaseMgr(DeployStep):
    ...
    def _handle_smart_app_description(self) -> DeployHandleResult:
        ...
        try:
            ...
            # 由于非 3 版本的 app_desc.yaml/Procfile 不支持显式配置 process services, 因此由平台隐示创建
            if result.spec_version != AppSpecVersion.VER_3:
                upsert_proc_svc_if_implicit_needed(app_environment.module)
