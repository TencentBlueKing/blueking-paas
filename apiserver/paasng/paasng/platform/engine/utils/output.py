...
def sanitize_message(message: str) -> str:
    """Sanitize the given message, remove bad characters and truncate it if it's too
    long.

    Sometimes the message was generated by program and can be very long(>10k), writing
    it directly to stream will cause performance issue and took too much storage, so
