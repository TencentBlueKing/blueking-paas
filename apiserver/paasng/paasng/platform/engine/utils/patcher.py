...
class ProcfilePatcher:
    ...
    def __init__(self, source_dir: Path, procfile: dict[str, str], module: "Module"):
    ...
    def apply(self):
        ...
        self.procfile_fpath.write_text(yaml.safe_dump(self.procfile))
