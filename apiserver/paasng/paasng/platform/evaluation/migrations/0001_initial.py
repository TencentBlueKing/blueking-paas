...
"""
# Generated by Django 3.2.12 on 2024-02-27 09:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_deployed_at', models.DateTimeField(null=True, verbose_name='最后部署时间')),
                ('operator', models.CharField(max_length=128, null=True, verbose_name='最后操作人')),
                ('issue_type', models.CharField(default=paasng.platform.evaluation.constants.OperationIssueType['NONE'], max_length=32, verbose_name='问题类型')),
                ('issues', models.JSONField(default=list, verbose_name='问题详情')),
                ('collected_at', models.DateTimeField(verbose_name='数据统计时间')),
                ('app', models.OneToOneField(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='applications.application')),
            ],
        ),
    ]
