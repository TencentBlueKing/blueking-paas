# Generated by Django 3.2.12 on 2023-03-20 10:41

from django.db import migrations, models
import django.db.models.deletion
import paasng.platform.log.models
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('elastic_search_host', paasng.platform.log.models.ElasticSearchHostField(help_text="required when backend_type is 'es'", null=True)),
                ('bk_log_config', paasng.platform.log.models.BKLogConfigField(help_text="required when backend_type is 'bkLog'", null=True)),
                ('search_params', paasng.platform.log.models.ElasticSearchParamsField(help_text='ES 搜索相关配置')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', paasng.platform.log.models.ContainerLogCollectorConfigField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('process_type', models.CharField(blank=True, max_length=16, null=True, verbose_name='进程类型(名称)')),
