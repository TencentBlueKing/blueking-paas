...
from paasng.accessories.bk_log.definitions import (
...
from paasng.platform.log.shim.bklog_custom_collector_config import get_or_create_custom_collector_config
