    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_prefix', models.CharField(max_length=32, null=True, verbose_name='自定义前缀')),
                ('tag_with_version_name', models.BooleanField(help_text='镜像Tag 是否带有分支/标签', null=True)),
                ('tag_with_build_time', models.BooleanField(help_text='镜像 Tag 是否带有构建时间', null=True)),
                ('tag_with_commit_id', models.BooleanField(help_text='镜像 Tag 是否带有提交ID(hash)', null=True)),
