...
from paasng.platform.modules.helpers import ModuleRuntimeBinder as _ModuleRuntimeBinder
...
class ModuleRuntimeBinder(_ModuleRuntimeBinder):
    def __init__(self, module, build_config):
        # Migration 中尽量只使用 apps 返回的 fake 模型, 用 fake 模型无法与普通模型进行关联, 所以重写了 ModuleRuntimeBinder 的构造函数
        self.module = module
...
def migrate_to_buildconfig(apps, schema_editor):
    ...
    for module in Module.objects.all():
        ...
        binder = ModuleRuntimeBinder(module, build_config)
