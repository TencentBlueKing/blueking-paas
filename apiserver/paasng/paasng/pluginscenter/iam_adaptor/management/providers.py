...
from paasng.pluginscenter.iam_adaptor.definitions import gen_iam_resource_id, gen_iam_resource_name
from paasng.pluginscenter.iam_adaptor.management.shim import fetch_grade_manager_members
