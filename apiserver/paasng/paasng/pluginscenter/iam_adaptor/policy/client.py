...
from paasng.pluginscenter.iam_adaptor.definitions import IAMResource
from paasng.pluginscenter.iam_adaptor.policy.converter import PluginPolicyConverter
