...
from paasng.pluginscenter.sourcectl.base import (
    AlternativeVersion,
    PluginRepoAccessor,
...
from paasng.pluginscenter.sourcectl.tencent import PluginRepoMemberMaintainer as TencentPluginRepoMemberMaintainer
