...
# 每个应用下最多创建的模块数量
MAX_MODULES_COUNT_PER_APPLICATION = int(settings.get('MAX_MODULES_COUNT_PER_APPLICATION', 10))
# 应用单个模块允许创建的最大 process 数量
MAX_PROCESSES_PER_MODULE = int(settings.get('MAX_PROCESSES_PER_MODULE', 8))
