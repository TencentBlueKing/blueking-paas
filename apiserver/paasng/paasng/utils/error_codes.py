...
class ErrorCodes:
    ...
    BUILD_DEBUG_STALE_DEPLOYMENT = ErrorCode(_("构建调试任务过期"), code_num=4311010)
    BUILD_DEBUG_UNAVAILABLE = ErrorCode(_("构建调试任务不可用"), code_num=4311011)
    # CI
    ...
    ARTIFACT_NOT_FOUND = ErrorCode(_("制品不存在"))
