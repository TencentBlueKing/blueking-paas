...
class TestAppSecret:
    ...
    def test_get_secret_perm(self, bk_app, api_client, two_enabled_app_secret_list, has_app_permission, status_code):
        with (
            ...
            mock.patch(
                ...
                return_value=has_app_permission,
            ),
        ):
    ...
    def test_create_secret(
        ...
        with (
            ...
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.create_app_secret", return_value=None),
            mock.patch(
                "paasng.infras.accounts.permissions.application.user_has_app_action_perm",
                return_value=has_app_permission,
            ),
    ...
    def test_toggle_secret_whit_no_db_default_secret(
        ...
        with (
            ...
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.toggle_app_secret", return_value=None),
            mock.patch(
                "paasng.infras.accounts.permissions.application.user_has_app_action_perm",
                return_value=has_app_permission,
            ),
    ...
    def test_delete_secret(
        ...
        with (
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.get_app_secret_list", return_value=app_secret_list),
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.get_secret_by_id", return_value=default_app_secret),
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.del_app_secret", return_value=None),
            mock.patch(
    ...
    def test_rotate_secret(
        ...
        with (
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.get_app_secret_list", return_value=app_secret_list),
            mock.patch("paasng.infras.oauth2.api.BkOauthClient.get_secret_by_id", return_value=app_secret_list[0]),
            mock.patch(
                "paasng.infras.accounts.permissions.application.user_has_app_action_perm",
                return_value=has_app_permission,
            ),
