...
from paasng.dev_resources.servicehub.exceptions import CanNotModifyPlan, ServiceObjNotFound
from paasng.dev_resources.servicehub.manager import mixed_service_mgr
from paasng.dev_resources.servicehub.models import RemoteServiceEngineAppAttachment
from paasng.dev_resources.servicehub.remote import RemoteServiceMgr, collector
from paasng.dev_resources.servicehub.remote.manager import MetaInfo, RemoteEngineAppInstanceRel, RemotePlanObj
...
class TestRemoteMgrWithMockedStore:
    ...
    @mock.patch("paasng.dev_resources.servicehub.services.get_application_cluster")
    @pytest.mark.parametrize(
    ...
    def test_get_attachment_by_instance_id(self, store, bk_module):
        ...
        for env in bk_module.envs.all():
            for rel in mixed_service_mgr.list_unprovisioned_rels(env.engine_app, svc):
                ...
                if plan.is_eager:
                    with mock.patch(
                        "paasng.dev_resources.servicehub.remote.client.RemoteServiceClient"
