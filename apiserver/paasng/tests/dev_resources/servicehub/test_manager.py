...
from paasng.dev_resources.servicehub.local import LocalServiceMgr, LocalServiceObj
from paasng.dev_resources.servicehub.manager import mixed_service_mgr
from paasng.dev_resources.servicehub.models import ServiceEngineAppAttachment
from paasng.dev_resources.servicehub.remote import RemoteServiceObj
from paasng.dev_resources.servicehub.services import ServiceInstanceObj
from paasng.dev_resources.services.models import Plan, Service, ServiceCategory, ServiceInstance
...
class TestMixedMgr:
    ...
    @mock.patch('paasng.dev_resources.servicehub.manager.MixedServiceMgr.list_provisioned_rels')
...
class TestLocalMgr(BaseTestCaseWithApp):
    ...
    @mock.patch('paasng.dev_resources.servicehub.constants.SERVICE_HIDDEN_FIELDS', {'mysql': ['MYSQL_PASSWORD']})
    @mock.patch('paasng.dev_resources.services.models.Service.create_service_instance_by_plan')
