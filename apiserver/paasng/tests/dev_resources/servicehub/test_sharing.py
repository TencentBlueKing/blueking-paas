...
from paasng.dev_resources.servicehub.exceptions import DuplicatedServiceBoundError, ReferencedAttachmentNotFound
from paasng.dev_resources.servicehub.manager import SharedServiceInfo, mixed_service_mgr
from paasng.dev_resources.servicehub.models import ServiceInstance
...
class TestGetEnvVariables:
    def test_local_integrated(self, bk_app, bk_module, local_service):
        ...
        with mock.patch('paasng.dev_resources.services.models.Service.create_service_instance_by_plan') as mocker:
