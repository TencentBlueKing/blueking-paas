...
from paasng.extensions.declarative.application.controller import APP_CODE_FIELD, AppDeclarativeController
...
from paasng.publish.market.models import Product, Tag
