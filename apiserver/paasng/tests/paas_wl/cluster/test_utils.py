...
from tests.paas_wl.utils.wl_app import random_wl_app
...
class TestGetClusterByApp:
    ...
    def setup(self, example_cluster_config):
        ...
        # 由于注册集群到 DB 后，未能刷新 _k8s_global_configuration_pool_map，考虑到本处不影响测试，因此通过 mock 处理
        with mock.patch(
    ...
    def test_get_cluster_by_app_normal(self):
        app = random_wl_app(force_app_info={'region': 'region-2'})
