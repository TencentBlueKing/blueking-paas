...
from paas_wl.cnative.specs.crd.bk_app import SvcDiscConfig, SvcDiscEntryBkSaaS
from paas_wl.cnative.specs.models import create_app_resource
from paas_wl.cnative.specs.svc_disc import ConfigMapManager, apply_configmap
