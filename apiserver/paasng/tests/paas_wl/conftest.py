...
from paas_wl.infras.resources.base.base import get_client_by_cluster_name, invalidate_get_global_configuration_pool
...
def django_db_setup(django_db_setup, django_db_blocker):  # noqa: PT004
    ...
    with django_db_blocker.unblock():
        with transaction.atomic():
            ...
            # in the pool.
            invalidate_get_global_configuration_pool()
