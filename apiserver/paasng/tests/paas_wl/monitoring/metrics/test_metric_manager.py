...
from tests.paas_wl.utils.wl_app import random_fake_instance, random_wl_app, release_setup
...
class TestResourceMetricManager:
    ...
    def setUp(self) -> None:
        self.app = random_wl_app(force_app_info={'region': settings.FOR_TESTS_DEFAULT_REGION})
        release_setup(wl_app=self.app)
