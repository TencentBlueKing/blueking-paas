...
from paasng.paas_wl.networking.ingress.domains.manager import CNativeCustomDomainManager, check_domain_used_by_market
...
class TestCNativeDftCustomDomainManager:
    ...
    @mock.patch('paasng.paas_wl.networking.ingress.domains.manager.deploy_networking')
    ...
    @mock.patch('paasng.paas_wl.networking.ingress.domains.manager.deploy_networking', side_effect=ValueError('foo'))
