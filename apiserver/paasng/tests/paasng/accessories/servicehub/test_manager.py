...
class TestMixedMgrBindService:
    ...
    @pytest.fixture()
    def policy_config(self, bk_app, plan1, plan2):
    ...
    def test_use_first_plan_ok(self, bk_module, service_obj, bk_stag_env, plan1, plan2):
        ServiceBindingPolicyManager(service_obj).set_static([plan2.uuid, plan1.uuid])
    ...
    def test_upsert_policy_combination(self, service_obj, bk_app, bk_module, plan1, plan2, policy_config):
        manager = ServiceBindingPolicyManager(service=service_obj)
        manager.upsert_policy_combination(policy_config)
    ...
    def test_get_policy_combination_configs(self, service_obj, policy_config):
        ...
        policy_combination_configs = manager.get_policy_combination_configs()
...
class TestLocalMgrProvisionAndInstance:
    ...
    def _with_static_binding_policy(self, service, plan_stag):
        ...
        proceed by default.
        """
        ServiceBindingPolicyManager(service).set_static([plan_stag.uuid])
