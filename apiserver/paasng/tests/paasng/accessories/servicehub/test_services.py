...
from paasng.accessories.servicehub.services import PlanObj, ServiceSpecificationHelper
...
class TestServiceSpecificationHelper:
    @mock.patch("paasng.accessories.servicehub.services.ServiceObj.get_plans")
