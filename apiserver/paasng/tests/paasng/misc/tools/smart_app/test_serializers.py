...
from paasng.misc.tools.smart_app.serializers import ToolPackageStashInputSLZ
...
class TestToolPackageStashInputSLZ:
    def test_valid_filename_pass(self):
        package = SimpleUploadedFile("package.tar.gz", b"data")
        slz = ToolPackageStashInputSLZ(data={"package": package})
