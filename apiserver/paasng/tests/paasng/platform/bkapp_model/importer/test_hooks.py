...
from paas_wl.bk_app.cnative.specs.crd.bk_app import BkAppHooks, Hook
...
class Test__import_hooks:
    def test_create(self, bk_module):
        ret = import_hooks(bk_module, BkAppHooks(preRelease=Hook(command=["foo", "bar"])))
    ...
    def test_delete(self, bk_module):
        ...
        ret = import_hooks(bk_module, BkAppHooks())
