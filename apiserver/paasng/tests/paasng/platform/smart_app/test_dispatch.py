...
from paasng.platform.smart_app.utils.dispatch import dispatch_slug_image_to_registry
...
def test_dispatch_slug_image_to_registry(
    ...
    8. 提交 App Image Manifest -> app_image_commit_url
    9. 验证镜像清单已上传成功 -> app_image_manifest_url
    """
    smart_asserts_path = assets_rootpath / "smart_app_v2"
    bk_module.name = "main"
    bk_module.save()
