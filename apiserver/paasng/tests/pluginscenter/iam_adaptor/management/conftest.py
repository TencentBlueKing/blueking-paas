...
from paasng.pluginscenter.iam_adaptor.management.client import BKIAMClient


@pytest.fixture
def iam_management_client():
    with mock.patch(
        "paasng.pluginscenter.iam_adaptor.management.shim.lazy_iam_client", new=BKIAMClient()
    ) as mocked_client:
