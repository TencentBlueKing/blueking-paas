...
from paasng.dev_resources.sourcectl.git.client import GitClient, GitCloneCommand, GitCommand
...
class TestGitClient:
    ...
    def test_list_refs(self, client, refs, expected):
        ...
        with patch.object(client, "run") as mock_run, patch(
            "paasng.dev_resources.sourcectl.git.client.GitClient._get_commit_info"
        ) as mock_commit_info:
