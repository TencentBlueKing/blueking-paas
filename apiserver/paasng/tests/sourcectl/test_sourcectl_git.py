...
from paasng.dev_resources.sourcectl.models import AlternativeVersion, VersionInfo
...
def mock_gitlab_client():
    with mock.patch("paasng.dev_resources.sourcectl.controllers.gitlab.GitLabApiClient") as client_clz:
        yield client_clz()
...
class TestGithubRepoController:
    ...
    @pytest.fixture
    def client(self):
        with mock.patch("paasng.dev_resources.sourcectl.controllers.github.GitHubApiClient") as client_clz:
            yield client_clz()
...
class TestGiteebRepoController:
    ...
    @pytest.fixture
    def client(self):
        with mock.patch("paasng.dev_resources.sourcectl.controllers.gitee.GiteeApiClient") as client_clz:
            yield client_clz()
...
class TestControllerUtils:
    ...
    def controller(self, gitlab_repo_url):
        with mock.patch("paasng.dev_resources.sourcectl.controllers.gitlab.GitLabApiClient"):
