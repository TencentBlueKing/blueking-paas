...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResRequestConfig) DeepCopyInto(out *ResRequestConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResRequestConfig.
func (in *ResRequestConfig) DeepCopy() *ResRequestConfig {
	if in == nil {
		return nil
	}
	out := new(ResRequestConfig)
	in.DeepCopyInto(out)
	return out
}
