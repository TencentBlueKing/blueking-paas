...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessUpdateStrategy) DeepCopyInto(out *ProcessUpdateStrategy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessUpdateStrategy.
func (in *ProcessUpdateStrategy) DeepCopy() *ProcessUpdateStrategy {
	if in == nil {
		return nil
	}
	out := new(ProcessUpdateStrategy)
	in.DeepCopyInto(out)
	return out
}
