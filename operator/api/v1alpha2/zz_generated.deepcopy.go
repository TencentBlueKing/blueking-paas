...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcResourcesGetter) DeepCopyInto(out *ProcResourcesGetter) {
	*out = *in
	if in.bkapp != nil {
		in, out := &in.bkapp, &out.bkapp
		*out = new(BkApp)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcResourcesGetter.
func (in *ProcResourcesGetter) DeepCopy() *ProcResourcesGetter {
	if in == nil {
		return nil
	}
	out := new(ProcResourcesGetter)
	in.DeepCopyInto(out)
	return out
}
