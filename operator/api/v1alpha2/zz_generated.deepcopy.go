...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AdminProcResConfig) DeepCopyInto(out *AdminProcResConfig) {
	{
		in := &in
		*out = make(AdminProcResConfig, len(*in))
		for key, val := range *in {
			var outVal map[string]AdminProcResourceSpec
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = make(map[string]AdminProcResourceSpec, len(*in))
				for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminProcResConfig.
func (in AdminProcResConfig) DeepCopy() AdminProcResConfig {
	if in == nil {
		return nil
	}
	out := new(AdminProcResConfig)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminProcResourceSpec) DeepCopyInto(out *AdminProcResourceSpec) {
	*out = *in
	if in.Limits != nil {
		in, out := &in.Limits, &out.Limits
		*out = new(AdminResource)
		**out = **in
	}
	if in.Requests != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminProcResourceSpec.
func (in *AdminProcResourceSpec) DeepCopy() *AdminProcResourceSpec {
	if in == nil {
		return nil
	}
	out := new(AdminProcResourceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdminResource) DeepCopyInto(out *AdminResource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdminResource.
func (in *AdminResource) DeepCopy() *AdminResource {
	if in == nil {
		return nil
	}
	out := new(AdminResource)
