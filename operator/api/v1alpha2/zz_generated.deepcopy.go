...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcResOverride) DeepCopyInto(out *ProcResOverride) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcResOverride.
func (in *ProcResOverride) DeepCopy() *ProcResOverride {
	if in == nil {
		return nil
	}
	out := new(ProcResOverride)
	in.DeepCopyInto(out)
	return out
}
