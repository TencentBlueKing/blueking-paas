...
// Reconcile ...
func (r *HookReconciler) Reconcile(ctx context.Context, bkapp *v1alpha2.BkApp) Result {
	...
	if hook := resources.BuildPreReleaseHook(bkapp, bkapp.Status.FindHookStatus(v1alpha2.HookPreRelease)); hook != nil {
...
// 获取应用当前在集群中的状态
func (r *HookReconciler) getCurrentState(ctx context.Context, bkapp *v1alpha2.BkApp) resources.HookInstance {
	currentStatus := bkapp.Status.FindHookStatus(v1alpha2.HookPreRelease)
	pod := corev1.Pod{}
	...
	if currentStatus == nil {
		currentStatus = &v1alpha2.HookStatus{
...
func (r *HookReconciler) ExecuteHook(
	ctx context.Context, bkapp *v1alpha2.BkApp, instance *resources.HookInstance,
) error {
	pod := corev1.Pod{}
...
func CheckAndUpdatePreReleaseHookStatus(
	ctx context.Context, cli client.Client, bkapp *v1alpha2.BkApp, timeout time.Duration,
