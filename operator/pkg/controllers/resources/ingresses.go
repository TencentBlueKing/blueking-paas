...
func MappingToDomainGroups(dgmapping *v1alpha1.DomainGroupMapping) []DomainGroup {
	domains := []DomainGroup{}
...
func TransformDomainGroup(dg v1alpha1.DomainGroup) DomainGroup {
	domains := lo.Map(dg.Domains, func(d v1alpha1.Domain, _ int) Domain {
...
func (builder MonoIngressBuilder) Build(domains []Domain) ([]*networkingv1.Ingress, error) {
	...
	if ingClassName := config.Global.GetIngressClassName(); ingClassName != "" {
		ingress.Annotations[v1alpha2.IngressClassAnnoKey] = ingClassName
	}
...
// Make rule objects
func makeRules(bkapp *v1alpha2.BkApp, domains []Domain) []networkingv1.IngressRule {
...
// Make path objects
func makePaths(bkapp *v1alpha2.BkApp, pathPrefixes []string) []networkingv1.HTTPIngressPath {
...
func (b *RegexLocationBuilder) MakeConfigurationSnippet(bkapp *v1alpha2.BkApp, domains []Domain) string {
	if len(domains) == 0 {
		return ""
	}
...
func (b *RegexLocationBuilder) MakeServerSnippet(bkapp *v1alpha2.BkApp, domains []Domain) string {
	return ""
}

// make server snippet, this method will call all registered plugins
func makeServerSnippet(bkapp *v1alpha2.BkApp, domains []Domain) string {
...
func makeConfigurationSnippet(bkapp *v1alpha2.BkApp, domains []Domain) string {
	return strings.Join(lo.Map(registeredIngressPlugins, func(plugin NginxIngressPlugin, i int) string {
