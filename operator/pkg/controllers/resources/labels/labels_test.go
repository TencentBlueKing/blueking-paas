	...
	Context("Deployment", func() {
		DescribeTable(
			...
			Entry(
				...
				"foo",
				"web",
				map[string]string{v1alpha2.BkAppNameKey: "foo", v1alpha2.ProcessNameKey: "web"},
			),
			Entry(
				"_ in app",
				"foo_app",
				"web",
				map[string]string{v1alpha2.BkAppNameKey: "foo_app", v1alpha2.ProcessNameKey: "web"},
			),
			Entry(
				"_ in process",
				"foo",
				"backend_worker",
				map[string]string{v1alpha2.BkAppNameKey: "foo", v1alpha2.ProcessNameKey: "backend_worker"},
			),
		)
	})
})
