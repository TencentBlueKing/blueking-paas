...
// ErrProcessNotExists 意味着进程在 bkapp 中未声明, 无法构建与进程关联的 Service
var ErrProcessNotExists = errors.New("process does not exist")
...
func BuildService(bkapp *v1alpha1.BkApp, process *v1alpha1.Process) *corev1.Service {
	...
	labels := labels.Deployment(bkapp, process.Name)
