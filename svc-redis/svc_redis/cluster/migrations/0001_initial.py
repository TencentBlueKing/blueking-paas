# Generated by Django 4.2.17 on 2025-04-17 07:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clb_ports', to='cluster.cluster')),
            ],
            options={
                'verbose_name': '腾讯云 CLB 端点',
                'verbose_name_plural': '腾讯云 CLB 端点',
