 ...
 * @param  {Boolean}  [atBegin]  Optional, defaults to false. If atBegin is false or unspecified,
 * callback will only be executed `delay` milliseconds
 * after the last debounced-function call. If atBegin is true,
