...
export default {
  ...
  'CodeCC 工具信息从代码仓库的配置文件中获取，': 'CodeCC tool information is retrieved from the configuration files in the code repository,',
  '可前往 tool.json 和 checkers.json 修改': 'You can go to tool.json and checkers.json to make modifications',
  工具类别: 'Tool Category',
