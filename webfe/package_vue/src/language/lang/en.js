...
export default {
  ...
  '重新发布': 'Republish',
  '发布状态': 'Post status',
  '版本号、代码分支': 'version number, code branch',
  '已有发布任务进行中': 'There are already publishing tasks in progress',
  '版本号类型': 'Version number type',
  '版本日志': 'Version Log',
  '正式': 'formal',
  '已上线': 'Online',
  '发布中': 'Publishing',
  ...
  '用于插件市场展示的信息': 'Information for plug-in marketplace presentations',
  '分类': 'Classification',
  '联系人': 'Contacts',
  '详细描述': 'Detailed description',
  '下架插件': 'Lower shelf Plugin',
  '插件下架后，插件列表、插件市场等不再展示该插件的信息': 'After a plug-in is removed from the shelf, the plug-in list and the plug-in market will not display the information of the plug-in',
  '退出插件': 'Exit plugin',
  '插件推广': 'Plugin promotion',
  '应用分类': 'App classification',
  '应用简介': 'App Introduction',
  '应用联系人': 'Contacts',
  '插件已发布成功': 'The plug-in has been published successfully',
  '返回插件版本列表': 'Return the plug-in version list',
  '重大版本': 'major release',
  '次版本': 'minor version',
  '修正版本': 'revised version',
  '版本类型': 'version type',
