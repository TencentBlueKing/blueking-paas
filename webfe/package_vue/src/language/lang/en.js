...
export default {
  ...
  '应用名称等基本信息请在应用描述文件 app_desc.yaml 中配置': 'Please configure basic information such as the application name in the APP description file app_desc.yaml',
  ...
  应用描述文件介绍: 'APP description file Overview',
  请先确认风险后再保存: 'Please confirm the risks before saving',
  '确认编辑{t}？': 'Confirm edit {t}?',
  '由应用描述文件 app_desc.yaml 定义': 'Defined by the APP description file app_desc.yaml',
  '当前值由应用描述文件定义，如果继续编辑，建议先删除应用描述文件的相关配置，否则重新部署时会覆盖填写的值。': 'The current value is defined by the APP description file. If you continue to edit, please delete the relevant configurations in the file first, or your changes may be overwritten during redeployment.',
  转换: 'Convert',
  转换成功: 'Conversion Successful',
  转换失败: 'Conversion Failed',
  应用描述文件转换: 'APP description file Conversion',
