...
export default {
  ...
  腾讯代码规范工具发布: 'Tencent Code Standard Tool Release',
  灰度发布: 'Gray Release',
  全量发布: 'Full Release',
  预发布: 'Pre-release',
  当前步骤: 'Current Step',
  申请预发布: 'Apply for Pre-release',
  预发布审批中: 'Pre-release approval in progress',
  预发布完成: 'Pre-release completed',
  预发布审批失败: 'Pre-release approval failed',
  '预发布审批中，请耐心等待': 'Pre-release approval in progress, please wait patiently',
  '全量发布审批中，请耐心等待': 'Full release approval in progress, please wait patiently',
  '腾讯代码规范工具发布需由<em>平台管理员</em>进行审批。': 'Tencent code standard tool release requires approval from the <em>platform administrator</em>.',
  '确认申请预发布？': 'Confirm applying for pre-release?',
  '确认申请全量发布？': 'Confirm applying for full release?',
