...
export default {
  ...
  '正在运行': 'Running',
  '申请云API权限': 'Apply for Cloud API Permission',
  ...
  '确认清除预发布环境出口IP信息？': 'Confirm to clear the the Stag Env external egress IP?',
  ...
  '文档管理': 'Documents',
  '蓝鲸SaaS研发管理参考规范': 'BlueKing SaaS R & D management reference specification',
  ...
  '蓝鲸PaaS平台 v3 版本分配的独立域名，如：http(s)://go-app-template.{{curAppInfo.cluster.ingress_config.app_root_domain}}/': 'The domain allocated by the BlueKing PaaS platform, such as: http(s)://go-app-template.{{curAppInfo.cluster.ingress_config.app_root_domain}}/',
  '蓝鲸PaaS平台分配的子路径访问地址，如：http(s)://{{curAppInfo.cluster.ingress_config.sub_path_domain}}/ieod-bkapp-ds-tools-stag/': 'The sub-path access address allocated by the BlueKing PaaS platform, such as: http(s)://{{curAppInfo.cluster.ingress_config.sub_path_domain}}/ieod-bkapp-ds-tools-stag/',
  '无法获取当前独立域名配置，错误': 'Unable to get the current independent domain name configuration, error',
  ...
  'CPU使用': 'CPU usage',
  '内存使用': 'Memory usage',
  '更多进程间通信的说明，请参看': 'For more information on inter-process communication, see',
  ...
  '示例镜像：mirrors.tencent.com/bkpaas/django-helloworld:latest': 'Example mirror: mirrors.tencent.com/bkpaas/django-helloworld:latest',
  '使用示例镜像': 'Use example mirror',
