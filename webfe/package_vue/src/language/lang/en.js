...
export default {
  ...
  '蓝鲸可视化开发平台的应用 ID 只能由小写字母组成, 所属应用': 'The application ID of the BlueKing visualization development platform can only be composed of lowercase letters, and the application belongs to',
  '的应用 ID 为': 'App ID is',
  '故无法在当前应用下创建蓝鲸可视化开发平台的模块。': 'Therefore, it is impossible to create modules of the BlueKing visualization development platform under the current application.',
  构建方式: 'Deploy',
