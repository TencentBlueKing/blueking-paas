...
export default {
  ...
  '可以通过挂载文件的方式，向容器中注入配置信息。': 'Configuration information can be injected into the container by mounting files.',
  新增挂载: 'Add new mount',
  挂载目录: 'Mount directory',
  文件内容详情: 'File content details',
  '新增/编辑挂载券': 'Add/edit mounting coupon',
  '请输入 2-30 字符的小写字母、数字、连字符(-)，以小写字母开头': 'Please enter 2-30 characters of lowercase letters, numbers, hyphens (-), starting with a lowercase letter',
  '唯一标识，创建后不可修改': 'Unique identifier, cannot be modified after creation',
  文件内容: 'Document Content',
  添加文件: 'Add files',
  目录格式不对: 'Directory format is wrong',
  同环境和路径挂载卷已存在: 'The volume mounted with the same environment and path already exists',
  '删除失败，请重新操作': 'Deletion failed, please try again',
  '文件同名！': 'The file has the same name!',
  挂载卷: 'Mount volume',
