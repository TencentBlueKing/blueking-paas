...
export default {
  ...
  环境变量配置: 'Env Variables Configuration',
  ...
  确认不写入环境变量: 'Confirm Not to Write to Env Variables',
  ...
  已配置为写入环境变量: 'Configured to Write to Env Variables',
  已配置为不写入环境变量: 'Configured Not to Write to Env Variables',
