...
export default {
  ...
  '开启后可通过"进程服务名称+服务端口"进行应用内部通信': 'Once enabled, internal application communication can be conducted via "process service name + service port".',
  '适合长时间运行的进程，可暴露给外部或内部流量': 'Suitable for long-running processes, can be exposed to external or internal traffic.',
