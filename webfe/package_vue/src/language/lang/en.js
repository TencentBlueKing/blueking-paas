...
export default {
  ...
  '标准运维V3使用的分布式的流程定义、管理、调度引擎': 'The distributed process definition, management and scheduling engine used by bksops.',
  推广: 'Marketing',
  '蓝鲸提供的官方应用市场，用户可以在市场中搜索并使用您开发的应用': 'The official APP marke provided by BlueKing, where users can search for and use APP.',
  ...
  '平台为该类应用提供应用引擎、增强服务、云 API 权限、应用市场等功能；适用于自主基于PaaS平台开发SaaS的场景。': 'The platform provides functions such as APP engine, enhanced services, cloud API permissions, and APP market for such APP; it is suitable for the scenario of independently developing SaaS based on the PaaS platform.',
