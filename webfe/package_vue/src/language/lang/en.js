...
export default {
  ...
  '如果您的应用描述文件版本是 spec_version: 2 且应用为云原生应用： 直接将描述文件转换为 specVersion: 3 后即可部署。': 'If your application descriptor file version is spec_version: 2 and the application is cloud-native, you can directly convert the descriptor file to specVersion: 3 and deploy.',
  '如果您的应用是普通应用：需要先将应用迁移到云原生应用，再更新描述文件版本': 'If your application is a traditional application, you need to first migrate it to a cloud-native application and then update the descriptor file version.',
