...
export default {
  ...
  '确认删除用户（{u}）的特性（{f}）？': 'Confirm deletion of attribute ({f}) for user ({u})?',
  '确认删除系统 API 账号': 'Confirm Deletion of System API Account',
  '删除后将不能再调用平台提供的系统 API': 'System APIs provided by the platform will no longer be callable after deletion',
  '该操作不可撤销，请输入用户名': 'This action is irreversible. Please enter the username',
  特性名称: 'Feature Name',
  默认值: 'Default Value',
  删除用户特性: 'Delete User Attribute',
