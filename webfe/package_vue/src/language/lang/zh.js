...
export default {
  ...
  '平台为该类应用提供应用引擎、增强服务、云 API 权限、应用市场等功能；适用于自主基于PaaS平台开发SaaS的场景。': '平台为该类应用提供应用引擎、增强服务、云 API 权限、应用市场等功能；适用于自主基于PaaS平台开发SaaS的场景。',
  '平台为该类应用提供应用引擎、增强服务等功能，并提供源码包部署和通过配置文件定义应用信息的能力；适用于熟知蓝鲸官方S-mart打包流程的SaaS开发场景。': '平台为该类应用提供应用引擎、增强服务等功能，并提供源码包部署和通过配置文件定义应用信息的能力；适用于熟知蓝鲸官方S-mart打包流程的SaaS开发场景。',
  首页: '首页',
  请填写名称: '请填写名称',
  该字段不能为空: '该字段不能为空',
  ...
  新增进程: '新增进程',
  使用示例: '使用示例',
  '镜像应监听“容器端口“处所指定的端口号，或环境变量值 $PORT 来提供 HTTP服务。': '镜像应监听“容器端口“处所指定的端口号，或环境变量值 $PORT 来提供 HTTP服务。',
  '接收HTTP请求的端口号．建议镜像直接监听$PORT环境变量不修改本值': '接收HTTP请求的端口号．建议镜像直接监听$PORT环境变量不修改本值',
  ...
  根据当前负载呵触发条件中设置的阈值自动扩缩容: '根据当前负载呵触发条件中设置的阈值自动扩缩容',
  '请输入 1 - 65535 的整数，非必填': '请输入 1 - 65535 的整数，非必填',
