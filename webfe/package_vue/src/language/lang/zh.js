...
export default {
  ...
  暂无钩子命令: '暂无钩子命令',
  '平台支持将自定义配置文件注入进程内的文件系统，还提供了持久存储功能以实现应用中所有模块和进程的数据共享。': '平台支持将自定义配置文件注入进程内的文件系统，还提供了持久存储功能以实现应用中所有模块和进程的数据共享。',
  新增挂载: '新增挂载',
  挂载目录: '挂载目录',
  文件内容详情: '文件内容详情',
  '新增/编辑挂载卷': '新增/编辑挂载卷',
  ...
  '挂载卷新增、编辑后，需要重新部署应用才能生效。': '挂载卷新增、编辑后，需要重新部署应用才能生效。',
  '挂载卷删除后，需要重新部署应用才能生效。': '挂载卷删除后，需要重新部署应用才能生效。',
  ...
  已绑定模块数: '已绑定模块数',
  '来确认删除存储！': '来确认删除存储！',
  '容量无法更改，请合理评估容量': '容量无法更改，请合理评估容量',
  '持久存储会申请对应容量的腾讯云 CFS，新建后就会产生实际的费用，请按需申请。': '持久存储会申请对应容量的腾讯云 CFS，新建后就会产生实际的费用，请按需申请。',
  ...
  '删除持久存储后无法恢复，目前有 {c} 个模块绑定了该存储，请确认影响': '删除持久存储后无法恢复，目前有 {c} 个模块绑定了该存储，请确认影响',
  '持久化存储使用腾讯云 CFS，可用于多个模块、进程间共享数据。': '持久化存储使用腾讯云 CFS，可用于多个模块、进程间共享数据。',
  暂无持久存储资源: '暂无持久存储资源',
  申请持久存储: '申请持久存储',
