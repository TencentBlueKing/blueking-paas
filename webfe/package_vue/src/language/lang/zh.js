...
export default {
  ...
  鉴权信息: '鉴权信息',
  '在调用蓝鲸云 API 时需要提供应用鉴权信息。使用方法请参考：':
    '在调用蓝鲸云 API 时需要提供应用鉴权信息。使用方法请参考：',
  别名: '别名',
  ...
  '蓝鲸可视化开发平台的应用 ID 只能由小写字母组成, 所属应用':
    '蓝鲸可视化开发平台的应用 ID 只能由小写字母组成, 所属应用',
  '的应用 ID 为': '的应用 ID 为',
  ...
  向右缩进: '向右缩进',
  向左缩进: '向左缩进',
  '由汉字、英文字母、数字、连字符和下划线组成，长度小于 20 个字符':
    '由汉字、英文字母、数字、连字符和下划线组成，长度小于 20 个字符',
  ...
  暂无进程: '暂无进程',
  '进程名和启动命令在构建目录下的 app_desc.yaml 文件中定义。':
    '进程名和启动命令在构建目录下的 app_desc.yaml 文件中定义。',
  暂无钩子命令: '暂无钩子命令',
  ...
  '总在启动容器时拉取镜像，每个镜像 Tag 默认仅拉取一次，如镜像 Tag 内容有更新，请勾选该选项':
    '总在启动容器时拉取镜像，每个镜像 Tag 默认仅拉取一次，如镜像 Tag 内容有更新，请勾选该选项',
  '执行 ID': '执行 ID',
  '镜像 tag': '镜像 tag',
  触发信息: '触发信息',
