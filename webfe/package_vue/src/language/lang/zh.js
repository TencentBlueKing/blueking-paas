...
export default {
  ...
  预发布完成: '预发布完成',
  预发布审批失败: '预发布审批失败',
  '预发布审批中，请耐心等待': '预发布审批中，请耐心等待',
  '全量发布审批中，请耐心等待': '全量发布审批中，请耐心等待',
  '腾讯代码规范工具发布需由<em>平台管理员</em>进行审批。': '腾讯代码规范工具发布需由<em>平台管理员</em>进行审批。',
  '确认申请预发布？': '确认申请预发布？',
  '确认申请全量发布？': '确认申请全量发布？',
  '蓝盾项目 ID': '蓝盾项目 ID',
  申请灰度发布: '申请灰度发布',
  ...
  申请成为管理员: '申请成为管理员',
  '请输入 3-20 字符的小写字母、数字、连字符(-)和下划线(_)，以小写字母开头': '请输入 3-20 字符的小写字母、数字、连字符(-)和下划线(_)，以小写字母开头',
};
