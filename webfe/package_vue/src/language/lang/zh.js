...
export default {
  ...
  'specVersion: 3 是针对云原生应用设计的最新规范，可以定义进程服务、可观测性等所有云原生应用的功能。': 'specVersion: 3 是针对云原生应用设计的最新规范，可以定义进程服务、可观测性等所有云原生应用的功能。',
  '请先在左侧输入 `spec_version: 2` 版本的应用描述文件，点击转换后将自动生成新版本': '请先在左侧输入 `spec_version: 2` 版本的应用描述文件，点击转换后将自动生成新版本',
  '如果您的应用描述文件版本是 spec_version: 2 且应用为云原生应用： 直接将描述文件转换为 specVersion: 3 后即可部署。如果您的应用是普通应用：需要先将应用迁移到云原生应用，再更新描述文件版本': '如果您的应用描述文件版本是 spec_version: 2 且应用为云原生应用： 直接将描述文件转换为 specVersion: 3 后即可部署。如果您的应用是普通应用：需要先将应用迁移到云原生应用，再更新描述文件版本',
};
