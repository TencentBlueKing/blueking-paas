...
export default {
  ...
  '请输入密码': '请输入密码',
  '模块删除成功': '模块删除成功',
  '确认清除预发布环境出口IP信息？': '确认清除预发布环境出口IP信息？',
  ...
  '蓝鲸PaaS平台 v3 版本分配的独立域名，如：http(s)://go-app-template.{{curAppInfo.cluster.ingress_config.app_root_domain}}/': '蓝鲸PaaS平台 v3 版本分配的独立域名，如：http(s)://go-app-template.{{curAppInfo.cluster.ingress_config.app_root_domain}}/',
  '蓝鲸PaaS平台分配的子路径访问地址，如：http(s)://{{curAppInfo.cluster.ingress_config.sub_path_domain}}/ieod-bkapp-ds-tools-stag/': '蓝鲸PaaS平台分配的子路径访问地址，如：http(s)://{{curAppInfo.cluster.ingress_config.sub_path_domain}}/ieod-bkapp-ds-tools-stag/',
  '无法获取当前独立域名配置，错误': '无法获取当前独立域名配置，错误',
  '更新失败，错误：': '更新失败，错误：',
  '删除失败': '删除失败',
  '实例': '实例',
