    ...
    export default {
            ...
            return {
                ...
                IPParamRules: {
                    content: [
                        ...
                        {
                            validator: value => {
                                return /([0,1]?\d{1,2}|2([0-4][0-9]|5[0-5]))(\.([0,1]?\d{1,2}|2([0-4][0-9]|5[0-5]))){3}/.test(value);
                            },
                            trigger: 'blur',
        ...
        methods: {
            ...
            checkUserParams (params) {
                ...
                const checkList = params.content.trim().split(';').filter(item => item !== '');
            ...
            async handleAddIp (payload = {}) {
                ...
                params.content = params.content.trim().split(';').filter(item => item !== '').join(';');
                try {
